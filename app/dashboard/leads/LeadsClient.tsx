        ...
        <table style={{ width:'100%', borderCollapse:'collapse' }}>
          <thead>
            <tr style={{ borderBottom:'1px solid var(--border)' }}>
              {['ID','Nome','Telefone','Email','Cadastro','Atendimento','Fase','Dias'].map(h=>(
          ...
          <tbody>
            {filtered.length===0 && (
              <tr><td colSpan={8} style={{ textAlign:'center', padding:48, color:'var(--muted)', fontSize:13 }}>Nenhum lead encontrado</td></tr>
            )}
            {filtered.map(l => {
